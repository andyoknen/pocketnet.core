...
#ifndef POCKETCOIN_NET_H
#define POCKETCOIN_NET_H
...
//    MANUAL,
     ...
     * Note that in the literature ("Eclipse Attacks on Pocketcoin’s Peer-to-Peer Network")
...
private:
    ...
    bool InactivityCheck(CNode *pnode);
    ...
    void SocketHandlerConnected(const std::vector<CNode*>& nodes,
        ...
        EXCLUSIVE_LOCKS_REQUIRED(!cs_totalBytesSent, !mutexMsgProc);
