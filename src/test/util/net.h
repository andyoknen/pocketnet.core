...
#ifndef POCKETCOIN_TEST_UTIL_NET_H
#define POCKETCOIN_TEST_UTIL_NET_H
...
struct ConnmanTestMsg : public CConnman {
    ...
    void NodeReceiveMsgBytes(CNode& node, char* pch, unsigned int nBytes, bool& complete) const;
...
#endif // POCKETCOIN_TEST_UTIL_NET_H
